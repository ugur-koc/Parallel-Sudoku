...
int main() {
   ...
   double time_diff;
   int puzzle[SIZE][SIZE] = { {0,0,0,11,0,12,0,15,0,3,0,0,0,0,0,0},
      {8,0,16,14,7,0,0,6,2,12,1,0,0,0,0,0},
      {9,0,0,12,16,0,21,5,7,11,0,0,0,0,0,4},
      {5,0,0,0,0,0,0,0,0,9,13,0,0,0,0,0},
      {0,0,12,3,0,16,0,0,6,0,0,15,8,0,11,1},
      {0,0,0,2,0,0,11,8,5,0,0,0,3,0,0,21},
      {0,0,0,0,15,13,0,0,0,2,0,0,16,0,0,0},
      {16,0,0,5,0,0,0,1,12,0,9,14,0,0,0,0},
      {21,0,0,0,0,0,13,0,0,0,0,16,7,9,1,8},
      {0,0,0,0,12,11,0,0,0,0,0,0,13,0,15,0},
      {0,8,0,0,0,0,0,0,1,6,21,0,0,0,12,0},
      {0,0,0,0,2,0,14,4,0,13,0,0,0,0,0,0},
      {14,12,0,15,0,0,0,0,13,0,0,0,0,11,0,16},
      {0,0,6,16,0,14,0,0,15,0,0,11,21,7,0,12},
      {7,9,0,0,16,8,15,0,0,0,14,0,6,0,4,0},
      {11,0,5,21,6,3,0,7,0,0,16,0,0,0,0,14}};
